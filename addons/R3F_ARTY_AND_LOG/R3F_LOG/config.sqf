...
[
	...
	"Land_Castle_01_wall_07_F", // Castle wall with walkway
	"Land_Castle_01_church_a_ruin_F", // Castle wall with windows
	"Land_Castle_01_wall_14_F",  // Castle wall with stairs (U shaped) 
	"Land_LightHouse_F", // Lighthouse
	"Land_Hangar_F", // Hanger
	"Land_Shed_Big_F", // Shed large
	"Land_Shed_Small_F", // Shed half
	"Land_Cargo_HQ_V1_F", // Mil HQ
	"Land_Medevac_HQ_V1_F" // Med HQ
];
