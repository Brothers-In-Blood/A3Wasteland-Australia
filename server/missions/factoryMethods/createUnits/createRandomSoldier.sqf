...
_uniformTypes = ["rhs_uniform_cu_ocp", "rhs_uniform_cu_ucp_1stcav" ,"rhs_uniform_FROG01_d"];
_vestTypes = ["rhsusf_spc_crewman","rhsusf_iotv_ucp_Repair"];
_weaponTypes = ["rhs_weap_m4","rhs_weap_m4a1_carryhandle","rhs_weap_m249_pip_S","rhs_weap_M590_5RD"];
