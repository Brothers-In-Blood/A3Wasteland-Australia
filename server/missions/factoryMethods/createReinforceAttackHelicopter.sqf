...
_createVehicle =
{
	...
	switch (true) do
	{
		case (_type isKindOf "RHS_AH1Z" || _type isKindOf "RHS_AH64D" || _type isKindOf "RHS_Mi24P_vvs"):
		{
		...
		case (_type isKindOf "RHS_UH1Y" || _type isKindOf "RHS_Mi8MTV3_vvs" || _type isKindOf "rhs_ka60_c"):
		{
