...
_setupObjects =
{
	...
	{
		["RHS_Mi24V_AT_vvs", "RHS_AH1Z"] call BIS_fnc_selectRandom;
	}
	else
	{
		["RHS_UH1Y", "RHS_UH60M"] call BIS_fnc_selectRandom;
	};
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			...
			case (_type isKindOf "RHS_AH1Z" || _type isKindOf "RHS_Mi24V_AT_vvs"):
			{
