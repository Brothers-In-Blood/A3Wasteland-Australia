...
_setupObjects =
{
	...
	_vehicles = [];
	_vehicles set [0, [_veh1,[10321.6,24857.7,0], 14, _aiGroup] call _createVehicle]; // static value update when porting to different maps
...
_successExec =
{
	...
	for "_i" from 1 to 10 do
	{
		...
		_cash setVariable ["cmoney", 70000, true];
	...
	_successHintMessage = "The sky is clear again, the enemy patrol was taken out! Ammo crates and money have appeared near the dead pilot.";
};
